...
<f7-page>
    ...
    <f7-popup class="demo-popup" :opened="splash" @popup:closed="popupOpened = false">
        <f7-page class="bg-blue-magenta">
            ...
            <f7-block :class="configuration.header_waves === 1 ? 'display-flex' : 'display-none'" class="no-margin-top no-margin-vertical no-padding-horizontal">
        ...
        <template v-if="!is_pos_mode">
            <f7-row>
                <f7-col v-if="checkPermissions('invoice')">
                    <f7-card @click.native="go('nw_doc')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content class="">
                            <base-icon nameIcon="file-invoice" widthIcon="35" clases="text-align-right padding-top"></base-icon>
                            <p class="font-w-500">Factura <br> electrónica</p>
                        </f7-card-content>
                    </f7-card>
                </f7-col>
                <f7-col v-if="checkPermissions('invoice-ticket')">
                    <f7-card @click.native="go('nw_docb')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content class="">
                            <base-icon nameIcon="file-invoice" widthIcon="35" clases="text-align-right padding-top"></base-icon>
                            <p class="font-w-500">Boleta <br> electrónica</p>
                        </f7-card-content>
                    </f7-card>
                </f7-col>
            </f7-row>
            ...
            <f7-row>
                <f7-col v-if="checkPermissions('purchase')">
                    <f7-card @click.native="go('purchase')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content class="">
                ...
                <f7-col v-if="checkPermissions('quotation')">
                    <f7-card @click.native="go('quotation')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content class="">
                            <base-icon nameIcon="file-sale" widthIcon="35" clases="text-align-right padding-top"></base-icon>
                            <p class="font-w-500">
                                <br> Cotización
            ...
            <f7-row>
                <f7-col v-if="checkPermissions('report-sales')">
                    <f7-card @click.native="go('report-sales')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content class="">
                            <base-icon nameIcon="bars" widthIcon="35" clases="text-align-right padding-top"></base-icon>
                            <p class="font-w-500"><br>Reportes</p>
                        </f7-card-content>
                    </f7-card>
                </f7-col>
                <f7-col v-if="checkPermissions('cash')">
                    <f7-card @click.native="go('cash')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content>
            ...
            <f7-row>
                <f7-col v-if="checkPermissions('customers')">
                    <f7-card @click.native="go('customers')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content>
                ...
                <f7-col  v-if="checkPermissions('items')">
                    <f7-card @click.native="go('items')" class="bg-white" style="cursor:pointer;">
                        <f7-card-content>
