    ...
    <f7-block class="no-padding-top no-padding-horizontal">
        <form class="form-store-data" id="demo-form">
            <f7-list no-hairlines-md>
                <f7-list-input floating-label type="text" clear-button label="URL" placeholder="demo.facturador.pro" required validate :value="form.url" @input="form.url = $event.target.value">
                ...
                <f7-list-input floating-label type="text" clear-button label="Correo" placeholder="Correo" name="name" required validate :value="form.email" @input="form.email = $event.target.value">
                </f7-list-input>
                <f7-list-input floating-label type="password" clear-button label="Contraseña" placeholder="Contraseña" name="password" required :value="form.password" @input="form.password = $event.target.value">
                </f7-list-input>
            </f7-list>
        </form>
    </f7-block>
